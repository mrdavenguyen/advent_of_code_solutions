...
def count_valid_passwords(input_list):
    ...
    for line in input_list:
        ...
        index_1, index_2 = position_1 - 1, position_2 - 1  # Convert to zero index

        # Exactly one of the positions must contain the letter
        password_count += (password[index_1] == letter) ^ (password[index_2] == letter)
